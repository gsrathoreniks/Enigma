...
public class Wildlife extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cv1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent ab=new Intent(Wildlife.this,Individual.class);
    ...
    public void onProfClick(View v){
        DrawerLayout drawer = (DrawerLayout) findViewById(R.id.drawer_layout);
        drawer.closeDrawer(GravityCompat.START);
        startActivity(new Intent(Wildlife.this, profile.class));
    }
    public void onFeedbackClick(View v){
        DrawerLayout drawer = (DrawerLayout) findViewById(R.id.drawer_layout);
        drawer.closeDrawer(GravityCompat.START);
        startActivity(new Intent(Wildlife.this, feedback.class));
    }
}
